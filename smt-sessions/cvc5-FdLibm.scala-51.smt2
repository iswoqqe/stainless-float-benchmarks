...
(assert (=> d!429 (=> (not res!508) (not e!323))))

(declare-fun lt!470 () tuple2!4)

(assert (=> d!429 (= res!508 (and (bvsle #b00000000000000000000000000011000 (_1!29 lt!470)) (bvsle (_1!29 lt!470) #b00000000000000000000001111110000) (= (bvsrem (_1!29 lt!470) #b00000000000000000000000000011000) #b00000000000000000000000000000000)))))

(declare-fun choose!11 ((_ FloatingPoint 11 53)) tuple2!4)

(assert (=> d!429 (= lt!470 (choose!11 x!199))))

(assert (=> d!429 (and (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) x!199) (not (fp.isInfinite x!199)) (not (fp.isNaN x!199)))))

(assert (=> d!429 (= (splitInput!0 x!199) lt!470)))

(declare-fun b!437 () Bool)

(assert (=> b!437 (= e!323 (xxInv!0 (_2!29 lt!470)))))

(assert (= (and d!429 res!508) b!437))
...
(assert (=> d!431 (=> (not res!511) (not e!326))))

(assert (=> d!431 (= res!511 (= (size!3 (_2!29 lt!466)) #b00000000000000000000000000000101))))

(assert (=> d!431 (= (xxInv!0 (_2!29 lt!466)) e!326)))
...
(assert (= (and d!431 res!511) b!440))
