...
(declare-fun lt!561 () tuple4!8)

(assert (=> b!509 (= e!395 (and (_3!31 lt!561) (or (bvsgt #b00000000000000000000000000000000 (_1!40 lt!561)) (bvsge (_1!40 lt!561) #b00000000000000000000000000001000) false false false)))))

(declare-fun lt!563 () (_ BitVec 32))
...
(assert (=> b!509 (= lt!561 (computeModulo!0 lt!563 (timesTwoOverPi!0 lt!563 (_1!41 lt!562) (_2!41 lt!562))))))

(declare-fun splitInput!0 ((_ FloatingPoint 11 53)) tuple2!18)

(assert (=> b!509 (= lt!562 (splitInput!0 x!199))))

(assert (=> b!509 (= lt!563 #b00000000000000000000000000000110)))
...
(assert (=> d!405 (=> (not res!583) (not e!398))))

(declare-fun lt!566 () tuple4!8)

(assert (=> d!405 (= res!583 (and (bvsle #b00000000000000000000000000000000 (_1!40 lt!566)) (bvslt (_1!40 lt!566) #b00000000000000000000000000001000) (= (size!10 (_4!4 lt!566)) #b00000000000000000000000000010100)))))

(declare-fun choose!17 ((_ BitVec 32) array!21) tuple4!8)

(assert (=> d!405 (= lt!566 (choose!17 lt!563 (timesTwoOverPi!0 lt!563 (_1!41 lt!562) (_2!41 lt!562))))))

(assert (=> d!405 (and (bvsle #b00000000000000000000000000000010 lt!563) (bvslt lt!563 #b00000000000000000000000000010011))))

(assert (=> d!405 (= (computeModulo!0 lt!563 (timesTwoOverPi!0 lt!563 (_1!41 lt!562) (_2!41 lt!562))) lt!566)))
...
(assert (= (and d!405 res!583) b!512))
...
(assert (=> d!407 (qInv!0 lt!569)))

(declare-fun choose!15 ((_ BitVec 32) (_ BitVec 32) array!21) array!21)

(assert (=> d!407 (= lt!569 (choose!15 lt!563 (_1!41 lt!562) (_2!41 lt!562)))))

(assert (=> d!407 (and (bvsle #b00000000000000000000000000000000 lt!563) (bvsle lt!563 #b00000000000000000000000000001111))))

(assert (=> d!407 (= (timesTwoOverPi!0 lt!563 (_1!41 lt!562) (_2!41 lt!562)) lt!569)))
...
(assert (=> d!409 (=> (not res!586) (not e!402))))

(declare-fun lt!572 () tuple2!18)

(assert (=> d!409 (= res!586 (and (bvsle #b00000000000000000000000000011000 (_1!41 lt!572)) (bvsle (_1!41 lt!572) #b00000000000000000000001111110000) (= (bvsrem (_1!41 lt!572) #b00000000000000000000000000011000) #b00000000000000000000000000000000)))))

(declare-fun choose!11 ((_ FloatingPoint 11 53)) tuple2!18)

(assert (=> d!409 (= lt!572 (choose!11 x!199))))

(assert (=> d!409 (and (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) x!199) (not (fp.isInfinite x!199)) (not (fp.isNaN x!199)))))

(assert (=> d!409 (= (splitInput!0 x!199) lt!572)))
...
(assert (= (and d!409 res!586) b!515))
...
(check-sat (not b!515) (not d!407) (not b!512) (not d!405) (not d!409))
(check-sat)
