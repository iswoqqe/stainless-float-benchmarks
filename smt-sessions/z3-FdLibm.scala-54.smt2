...
(assert (=> start!495 (=> (not res!531) (not e!348))))

(declare-fun x!199 () (_ FloatingPoint 11 53))

(assert (=> start!495 (= res!531 (and (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) x!199) (not (fp.isInfinite x!199)) (not (fp.isNaN x!199))))))
...
(assert (=> b!460 (=> (not res!532) (not e!347))))
...
(assert (=> b!460 (= res!532 (not (_3!27 (computeModulo!0 lt!500 (timesTwoOverPi!0 lt!500 (_1!32 lt!499) (_2!32 lt!499))))))))
...
(assert (= (and start!495 res!531) b!460))

(assert (= (and b!460 res!532) b!461))
