...
(assert (=> b!9306 m!16781))

(declare-fun m!16783 () Bool)

(assert (=> b!9312 m!16783))
...
(assert (=> b!9316 m!16791))

(assert (=> b!9313 m!16761))

(assert (=> b!9313 m!16777))

(assert (=> b!9313 m!16783))

(assert (=> b!9313 m!16787))
